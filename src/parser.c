...
static bool ts_lex(TSLexer *lexer, TSStateId state) {
  ...
  switch (state) {
    case 0:
      ...
      if (sym_identifier_character_set_1(lookahead)) ADVANCE(38);
      END_STATE();
    case 1:
      if (lookahead == '\n') ADVANCE(55);
    ...
    case 38:
      ...
      if (sym_identifier_character_set_2(lookahead)) ADVANCE(38);
      END_STATE();
    case 39:
...
static const uint16_t ts_parse_table[LARGE_STATE_COUNT][SYMBOL_COUNT] = {
  ...
  [1] = {
    ...
    [aux_sym_module_repeat2] = STATE(37),
...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [47] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__expressions, 1),
  [49] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_binary_op, 3),
  [51] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_binary_op, 3),
  ...
  [75] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym__expressions_repeat1, 2),
  ...
  [89] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_unary_op, 2),
  [91] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_unary_op, 2),
  ...
  [101] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_module_repeat2, 2),
  [103] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_module_repeat2, 2), SHIFT_REPEAT(10),
  [106] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_module_repeat2, 2), SHIFT_REPEAT(49),
  [109] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_module_repeat2, 2), SHIFT_REPEAT(49),
  [112] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_module_repeat2, 2), SHIFT_REPEAT(23),
  [115] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_module_repeat2, 2), SHIFT_REPEAT(10),
  [118] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_module_repeat2, 2), SHIFT_REPEAT(40),
  [121] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_module_repeat2, 2), SHIFT_REPEAT(74),
  [124] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_module_repeat2, 2), SHIFT_REPEAT(73),
  [127] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_module, 2),
  ...
  [233] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_module_repeat2, 2),
  [235] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_module_repeat1, 2),
  [237] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_module_repeat1, 2),
  [239] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_module_repeat1, 2), SHIFT_REPEAT(65),
  [242] = {.entry = {.count = 1, .reusable = false}}, SHIFT_EXTRA(),
  [244] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_string_repeat1, 2),
  [246] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_string_repeat1, 2), SHIFT_REPEAT(91),
  [249] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_string_repeat1, 2), SHIFT_REPEAT(38),
  [252] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_string_repeat1, 2), SHIFT_REPEAT(66),
  ...
  [273] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_string_repeat1, 2), SHIFT_REPEAT(88),
  [276] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_string_repeat1, 2), SHIFT_REPEAT(39),
  [279] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_string_repeat1, 2), SHIFT_REPEAT(70),
  ...
  [292] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_string_repeat1, 3),
  [294] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__expressions_repeat1, 2), SHIFT_REPEAT(55),
  [297] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__expressions, 2),
  [299] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__expressions_repeat1, 2), SHIFT_REPEAT(56),
...
extern "C" {
#endif
void *tree_sitter_koto_external_scanner_create(void);
void tree_sitter_koto_external_scanner_destroy(void *);
bool tree_sitter_koto_external_scanner_scan(void *, TSLexer *, const bool *);
unsigned tree_sitter_koto_external_scanner_serialize(void *, char *);
void tree_sitter_koto_external_scanner_deserialize(void *, const char *, unsigned);
...
extern const TSLanguage *tree_sitter_koto(void) {
  static const TSLanguage language = {
    ...
    .external_scanner = {
      ...
      tree_sitter_koto_external_scanner_create,
      tree_sitter_koto_external_scanner_destroy,
      tree_sitter_koto_external_scanner_scan,
      tree_sitter_koto_external_scanner_serialize,
      tree_sitter_koto_external_scanner_deserialize,
    },
